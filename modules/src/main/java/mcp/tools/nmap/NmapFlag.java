...
public enum NmapFlag
{
	...
	PING_SCAN("-sn", "Ping Scan - disable port scan"),
	...
	NEVER_DO_DNS("-n", "Never do DNS resolution [default: sometimes]"),
	ALWAYS_DO_DNS("-R", "Always do DNS resolution [default: sometimes]"),
	...
	SCRIPT_ARGS_FILE("--script-args-file", "--script-args-file=filename: provide NSE script args in a file"),
	...
	PROXIES("--proxies", "--proxies <url1,[url2],...>: Relay connections through HTTP/SOCKS4 proxies"),
	...
	// WEBXML("--webxml", "Reference stylesheet from Nmap.Org for more portable XML"), // http://nmap.org/data/nmap.xsl
	...
	private NmapFlag(String f, String c)
	{
		flag = f;
		comment = c;
	}
